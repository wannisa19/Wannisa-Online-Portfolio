...
import { Briefcase, Building, Users, Zap } from "lucide-react";
import { useRef } from "react";

const stats = [
  { icon: Briefcase, value: "5+", label: "Years Experience" },
  { icon: Building, value: "4", label: "Companies" },
...
export default function About() {
  ...
  return (
    <section
      ...
      style={{
        background: "linear-gradient(180deg, #050d1a 0%, #070f1f 100%)",
      }}
    >
      <div
        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          <div className="space-y-6">
            ...
            <motion.p {...anim(0.2)} className="text-slate-400 leading-relaxed">
              ...
              management, and enterprise SaaS — collaborating closely with
              Business Analysts to translate complex requirements into clean,
              maintainable code. I thrive in cross-functional teams and take
              ownership of delivering high-quality solutions end-to-end.
            </motion.p>
            ...
            <motion.div {...anim(0.4)} className="flex flex-wrap gap-3 pt-2">
              {/* <a
